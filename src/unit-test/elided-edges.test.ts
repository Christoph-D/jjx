...
import { classifyEdges, insertSyntheticNodes, getUniqueEntryId, getParentUniqueId } from "../elided-edges";
import type { ClassifiedEdge } from "../elided-edges";
...
describe("elidedEdges", () => {
  ...
  describe("insertSyntheticNodes", () => {
    ...
    it("real-world repo with missing parent", () => {
      ...
      assert.deepStrictEqual(wtEntry.parents[0].change_id, "~nx/0");
