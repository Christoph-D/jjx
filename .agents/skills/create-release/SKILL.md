...
5. **Get user confirmation:**
   Present the proposed tag value and the proposed changes to CHANGELOG.md to the user. Ask them to review and confirm before proceeding. Do not continue until the user approves.
