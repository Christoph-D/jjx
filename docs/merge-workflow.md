...
This document describes how a third-party tool can use only the jj CLI to obtain the base, left, and right file contents
for a conflicted file, enabling integration with external 3-way merge tools.
